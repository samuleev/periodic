...
@section('seo_headers')
    ...
    <meta name="keywords" content="інформаційна підтримка, надання консультативної допомоги авторам, підготовка наукових статей">
    <meta name="description" content="Наукова співпраця ХНУПС">
@stop

@section('bread_crumbs')
    <li class="active">Співпраця</li>
@stop

@section('lang_switch')
    <a style="color:#FFFFFF;text-decoration: none;" href="{{{route('eng.page.cooperation')}}}" alt="English version">
    ...
    <div class="container">
        <div class="row" style="margin-top:21px;">
            <div class="col-md-12">
                ...
                <ul>
                    <li>інформаційна підтримка наукових видань;</li>
                    <li>надання консультативної допомоги авторам щодо підготовки наукових статей для публікацій у журналах-партнерах.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/nauka_i_oborona.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://www.nio.mil.gov.ua/">www.nio.mil.gov.ua</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/vtz.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://vtz.asv.gov.ua">vtz.asv.gov.ua</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/bolyai_review.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://uni-nke.hu/kutatas/egyetemi-folyoiratok/bolyai-szemle/aktualis-szam">uni-nke.hu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/hadmernok.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            Військовий інженер є періодичним щоквартальним он-лайн виданням Національного університету державної служби Угорщини, яке було засновано у 2006 році.
                            <br><br>
                            Метою видання є публікація результатів досліджень викладачів, аспірантів та студентів вищих навчальних закладів з військово-інженерних наук та суміжних галузей.
                            <br><br>
                            Тематика публікацій: Воєнна безпека. Бойова підготовка. Військова логістика та транспорт. Екологічна безпека, запобігання та ліквідація надзвичайних ситуацій. Картографія та геоінформатика. Економічні проблеми оборони. Інформаційні технології та комунікації. Проблеми управління військами.
                            <br><br>
                            Видається англійською та угорською мовами.
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://www.hadmernok.hu/">www.hadmernok.hu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/military_engineering_journal.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            Видається англійською та угорською мовами.
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://www.hhk.uni-nke.hu/downloads/kiadvanyok/mkk.uni-nke.hu/index.html">www.hhk.uni-nke.hu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/military_science_review.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://uni-nke.hu/kutatas/egyetemi-folyoiratok/hadtudomanyi-szemle/aktualis-szam">uni-nke.hu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="conrainer">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 top10 bottom10">
                            <img class="img-thumbnail" src="/periodic-app/public/img/gnda.jpg" />
                        </div>
                        <div class="col-md-9 top10 bottom10">
                            ...
                            <br><br>
                            Веб-сторінка видання: <a target="_blank" href="http://eta.edu.ge/">eta.edu.ge</a>
                        </div>
                    </div>
                </div>
            </div>
